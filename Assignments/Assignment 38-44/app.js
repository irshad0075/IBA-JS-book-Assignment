...
function power(a, b) {
  ...
  console.log(`${a} raised to ${b} is ${result}.`);
  return result;
}
...
calcArea(3, 4, 5); // Output: It will return the area of triangle
...
function mainFunction(subject1, subject2, subject3) {
  ...
  console.log(
    `The average marks are ${average} and the percentage is ${percentage}%.`
  );
}
...
console.log(myIndexOf("hello world", "o"));
