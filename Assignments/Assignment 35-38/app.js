...
calculator(5, 3, "+"); // Output: The result of 5 + 3 is 8.
calculator(5, 3, "-"); // Output: The result of 5 - 3 is 2.
calculator(5, 3, "*"); // Output: The result of 5 * 3 is 15.
calculator(5, 3, "/"); // Output: The result of 5 / 3 is 1.6666666666666667.
calculator(5, 3, "%"); // Output: The result of 5 % 3 is Invalid operator.
...
function capitalizeFirstLetter(str) {
  ...
  console.log(`The capitalized string is "${capitalizedStr}".`);
